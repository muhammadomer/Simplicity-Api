...
{
    public class WebThirdPartiesRepository : IWebThirdPartiesRepository
    {
        ...
        public WebThirdPartiesRepository()
        {
            
        }

        public WebThirdParties Login(string userLogon, string userEnable, string projectId, HttpResponse Response)
        {
                ...
                if (!string.IsNullOrWhiteSpace(projectId))
                {
                    ...
                    if (settings != null)
                    {
                        ...
                        else
                        {
                            ...
                            string token = userSession.CreateUserSession(user.WebId, user.UserLogon, projectId);
